...
![Downloads (release-13.0.0)](https://img.shields.io/github/downloads/neovatar/more-text-options/release-13.0.0/fux-dice-roller.zip?style=for-the-badge&label=Downloads%20%28release-13.0.0%29)
...
[![License](https://img.shields.io/github/license/neovatar/more-text-options?label=License)](LICENSE)
...
This module is based on the [Advanced Drawing Tools](https://github.com/DawidIzydor/advanced-drawing-tools) module which does not yet support Foundry v14 yet. "More Text Options" is basically a code snippet of this module with a few additional fixes. Since the text formatting is the only part I really needed, I decided to fork that part of the code.
